	...
	<div class="comment-list-section" id="commentList">
		...
		<c:if test="${sessionScope.user != null}">
			<div class="comment-form-section">
				<h2>댓글 쓰기</h2><h4 style="margin-bottom: 5px;">작성자: ${sessionScope.user.us_nickname }</h4>
		...
		<c:if test="${sessionScope.user == null}">
			...
			<h2>댓글 쓰기</h2>
				<form name="loginFrm" action="Controller" method="get"  class="comment-form"  style="display: flex; align-items: flex-start;">
					...
					<input type="hidden" name="url" value="?type=noticeDetail&bo_idx=${vo.bo_idx}&bo_type=${vo.bo_type}&cPage=${requestScope.cPage}"/>
