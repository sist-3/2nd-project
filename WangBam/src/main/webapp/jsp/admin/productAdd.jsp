<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8" %>
	<%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
		<%@include file="/jsp/common/adminHeader.jsp" %>
			<div class="admin">
				<h1>상품 추가</h1>
				<form class="form-group" method="POST" action="admin?type=productSave" enctype="multipart/form-data"
					name="addForm">
					<div>
						<label for="username">상품명</label> <input type="text" id="item_name" name="pd_name"
							placeholder="상품명" data-label="상품명">
					</div>
					<div>
					...
					<div>
						<label for="cnt">수량</label> <input type="text" id="cnt" name="pd_cnt" placeholder="수량"
							data-label="수량">
					</div>
					<div>
					...
					<div>
						...
						<div>
							...
							<input type="file" name="pd_thumbnail_img" id="pdThumbnailImg" data-label="썸네일이미지"
					...
					<div>
						...
						<div>
							...
							<input type="file" name="pd_detail_img" id="pdDetailImg" data-label="상세이미지"
								onchange="selectImg(this)">
						</div>
					</div>
			...
			<%@include file="/jsp/common/footer.jsp" %>
				<script>
					...
					function add() {
						...
						if (pass) {
							dialog("dialog-confirm", "추가하시겠습니까?", {
								"확인": function () {
									$(this).dialog("close");
									dialog("dialog-confirm", "추가완료!", {
										"확인": function () {
											$(this).dialog("close");
